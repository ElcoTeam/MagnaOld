<%@ WebHandler Language="C#" Class="StepHandler" %>
...
public class StepHandler : IHttpHandler
{
    ...
    void SaveStep()
    {
        ...
        string step_plccode = Request.Params["step_plccode"];
				string step_barcode_startindex = Request.Params["step_barcode_startindex"];
								string step_barcode_length = Request.Params["step_barcode_length"];
        ...
        model.step_plccode = NumericParse.StringToInt(step_plccode);
								//model.step_barcode_startindex = NumericParse.StringToInt(step_barcode_startindex);
								//								model.step_barcode_length = NumericParse.StringToInt(step_barcode_length);
