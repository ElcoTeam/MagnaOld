<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true"
    CodeFile="adminpwd.aspx.cs" Inherits="AdminCMS_System_adminpwd" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="pwd2" runat="server"></asp:TextBox><td class="title" colspan="2">
