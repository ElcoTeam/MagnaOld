...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <!-- 编辑窗口 -->
    <div id="w" style="padding: 10px; visibility: hidden" title="零件编辑">
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td rowspan="13" style="width: 450px; padding-left: 20px; vertical-align: top">
                    <!-- 数据表格  -->
    ...
    <script>
        ...
        $(function () {
            ...
            dg = $('#tb').datagrid({
                url: "/HttpHandlers/BOMHandler.ashx?method=queryBOMList",
                rownumbers: true,
                pagination: true,
                singleSelect: true,
                collapsible: false,
