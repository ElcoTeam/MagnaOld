...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <tr>
                ...
                <td style="width: 150px;">
                    <select id="fl_id_s" class="easyui-combobox" style="width: 200px; height: 25px;"
                        data-options="valueField: 'fl_id',textField: 'fl_name',onSelect:function(){reloadst_id_s();}">
                    </select></td>
                <td style="width: 150px;">
    ...
    <div id="w" style="padding: 10px; visibility: hidden" title="步骤编辑">
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td>
                    <input id="step_barcode_startindex" type="text" class="text" style="width: 130px;" />
                </td>
            </tr>
					<tr>
                <td class="title">
                ...
                <td>
                    <input id="step_barcode_length" type="text" class="text" style="width: 130px;" />
                </td>
            </tr>
            <tr>
                <td class="title">
    ...
    <script>
            ...
            dg = $('#tb').datagrid({
                ...
                { field: 'bom_count', title: '零件数量', width: 80, align: "center" },
                 { field: 'step_clock', title: '理想工时', width: 80, align: "center" },
                      ...
                      { field: 'step_barcode_startindex', title: '条码匹配开始位', width: 80, align: "center" },
                      { field: 'step_barcode_length', title: '条码匹配长度', width: 80, align: "center" },
        ...
        function saveStep() {
            ...
            var step_barcode_startindex = $('#step_barcode_startindex').val();
            var step_barcode_length = $('#step_barcode_length').val();
            ...
            var model = {
                ...
                step_barcode_startindex: step_barcode_startindex,
                step_barcode_length: step_barcode_length,
                bom_count: bom_count,
                step_pic: step_pic,
                step_desc: step_desc,
                //odsName: odsName,
        ...
        function initEidtWidget() {
            ...
            $('#step_barcode_startindex').val(row.step_barcode_startindex);
            $('#step_barcode_length').val(row.step_barcode_length);
        ...
        function clearw() {
            ...
            $('#step_clock').val('');
            $('#step_plccode').val('');
            $('#step_barcode_startindex').val('');
            $('#step_barcode_length').val('');
            $('#bom_count').val('');
            $('#step_desc').val('');
