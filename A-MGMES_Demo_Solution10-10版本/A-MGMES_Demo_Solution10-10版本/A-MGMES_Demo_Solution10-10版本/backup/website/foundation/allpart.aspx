<%@ Page Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="allpart.aspx.cs" Inherits="foundation_allpart" ValidateRequest="false" %>
    ...
    $(function () {
        ...
        dg = $('#tb').datagrid({
            ...
            columns: [[
                  ...
                  { field: 'all_no', title: '订单代号', width: 200, align: "center" },
                  { field: 'all_ratename', title: '车型', width: 200, align: "center" },
                  { field: 'all_colorname', title: '颜色', width: 100, align: "center" },
                  { field: 'all_metaname', title: '材质', width: 100, align: "center" },
                  { field: 'all_desc', title: '备注', width: 300, align: "center" },
                  { field: 'all_id', title: '查看关系网', align: "center", width: 80, formatter: function (value, row, index) { return '<img src="/image/admin/chukoulist.png" style="height:16px;cursor:pointer" onclick="showRelation(\'' + value + '\');"/>'; }, }
            ]]
        });
        //数据列表分页
        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td style="width: 100px;">
                    <asp:TextBox ID="txt_no" runat="server" Width="100px"></asp:TextBox>
                </td>
                <td style="width:20px;"></td>
                <td style="width: 100px;">座椅配置：&nbsp;</td>
                <td style="width: 100px;">
                    <asp:TextBox ID="txt_rate" runat="server" Width="100px"></asp:TextBox>
                </td>
                <td style="width:20px;"></td>
                <td style="width: 70px;">颜色：&nbsp;</td>
                <td style="width: 70px;">
                    <asp:TextBox ID="txt_color" runat="server" Width="70px"></asp:TextBox>
                </td>
                <td style="width:20px;"></td>
                <td style="width: 70px;">材质：&nbsp;</td>
                <td style="width: 70px;">
                    <asp:TextBox ID="txt_metaname" runat="server" Width="70px"></asp:TextBox>
                </td>
                <td style="width:20px;"></td>
                ...
                <td style="width: 100px; text-align: right">
                    <asp:Button ID="Button1" runat="server" Text="新增座椅"  CssClass="addBtn" OnClick="Button1_Click" />
                </td>
            </tr>
        </table>
    </div>
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        DataKeyNames="all_id" CssClass="gridview" OnPageIndexChanging="GridView1_PageIndexChanging" >
        <Columns>
            <asp:TemplateField HeaderText="座椅ID">
                <EditItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("all_id") %>'></asp:Label>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("all_id") %>'></asp:Label>
                </ItemTemplate>
                <HeaderStyle Width="70px" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="座椅编号">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("all_no") %>' Width="100px"></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label3" runat="server" Text='<%# Bind("all_no") %>'></asp:Label>
                </ItemTemplate>
                <HeaderStyle Width="100px" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="配置">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("all_ratename") %>' Width="100px"></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label4" runat="server" Text='<%# Bind("all_ratename") %>'></asp:Label>
                </ItemTemplate>
                <HeaderStyle Width="100px" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="颜色">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("all_colorname") %>' Width="70px"></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label5" runat="server" Text='<%# Bind("all_colorname") %>'></asp:Label>
                </ItemTemplate>
                <HeaderStyle Width="70px" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="材质">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("all_metaname") %>' Width="70px"></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label6" runat="server" Text='<%# Bind("all_metaname") %>'></asp:Label>
                </ItemTemplate>
                <HeaderStyle Width="70px" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="描述">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox5" runat="server" Text='<%# Bind("all_desc") %>' Width="200px"></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label7" runat="server" Text='<%# Bind("all_desc") %>'></asp:Label>
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="功能">
                ...
                <EditItemTemplate>
                    <asp:ImageButton ID="BtSave" runat="server" ImageUrl="~/image/admin/save.png" Height="16px" OnClick="BtSave_Click" />
                    &nbsp;&nbsp;&nbsp;&nbsp;
