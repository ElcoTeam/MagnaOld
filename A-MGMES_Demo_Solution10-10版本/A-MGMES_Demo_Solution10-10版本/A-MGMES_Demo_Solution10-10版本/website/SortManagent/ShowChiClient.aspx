<%@ Page Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeBehind="ShowChiClient.aspx.cs" Inherits="website.SortManagent.ShowChiClient"  ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script>    
        ...
        //数据列表加载
        dg = $('#tb').datagrid({
            url: "/HttpHandlers/ShowChiClient.ashx?method=queryShowChiClientList",
            rownumbers: true,
            pagination: true,          
            singleSelect: true,
            collapsible: false,
            ...
            columns: [[
                  ...
                  { field: 'SName', title: '手持端名称', width: 152, align: "center" },
                  { field: 'ClientIP', title: '手持端IP ', width: 180, align: "center" },
                  { field: 'SAddTime', title: '添加时间', width: 182, align: "center" },
                  { field: 'SRole', title: '手持端权限', width: 700, align: "center"},
