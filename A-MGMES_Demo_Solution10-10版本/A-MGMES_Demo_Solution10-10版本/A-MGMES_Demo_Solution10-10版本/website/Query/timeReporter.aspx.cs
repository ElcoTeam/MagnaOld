...
{
    public partial class timeReporter : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //导出Excel
                ExportByWebNew("时间信息报表.xls");
            }
        }
        public static void ExportByWebNew(string fileName)
        {
            string filePath = HttpContext.Current.Request.MapPath("~/App_Data/时间信息报表.xlsx");
        ...
        {
            string path = HttpContext.Current.Request.MapPath("~/App_Data/时间信息报表.xlsx");
            //调用ZK的ExcelHelper
