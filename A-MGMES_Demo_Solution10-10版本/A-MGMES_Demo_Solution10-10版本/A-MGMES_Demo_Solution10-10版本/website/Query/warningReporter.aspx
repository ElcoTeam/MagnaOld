  ...
  <div id ="gridPanel">
    ...
    <script>
        ...
        $(function () {
            ...
            $("#end_time").datetimebox('setValue', date_t.toTimeString());
            $.ajaxSetup({
        ...
        function GetGrid() {
            ...
            dg = $('#gridTable').datagrid({
                ...
                striped: true,
                collapsible: false,
                url: '/HttpHandlers/Services1002_WaringList.ashx?method=GetListNew',
                showFooter: true,
                sortName: 'stationNo',
                sortOrder: 'asc',
                ...
                columns: [[
                            ...
                            {
                                field: 'fl_name', title: '流水线', align: 'center', width: 100,
                            ...
                            },
                            {
                             ...
                             {
                                 field: 'stop_num', title: 'Stop 急停', align: "center", width: 100,
                                 styler: setMaintenance_Styler,
                             },
                            {
        ...
        function excelFor() {
            ...
            $.ajax({
                ...
                cache: false,
                dataType: 'json',
                data: { "fl_id": "" + fl_id + "", "start_time": "" + start_time + "", "end_time": "" + end_time + "", "method": "Export" },
                cache: false,
                success: function (data) {
                    if (data.Result == "true") {
                        $("#subs").click();
        ...
        function print() {
            ...
            $.ajax({
                type: 'post',
                url: '/HttpHandlers/Services1002_WaringList.ashx?method=Print',
                async: false,
                cache: false,
                dataType: 'json',
