<%@ Page Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" Inherits="foundation_Station" ValidateRequest="false" Codebehind="Station.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="w" style="padding: 10px; visibility: hidden" title="工位编辑">
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td colspan="2">
                    <input id="st_clock_Start" type="text" class="text" style="width: 230px;" />
                </td>
            </tr>
            <tr>
                <td class="title">
                ...
                <td colspan="2">
                    <input id="st_clock" type="text" class="text" style="width: 230px;" />
                </td>
            </tr>
            <tr>
    ...
    <script>
            ...
            dg = $('#tb').datagrid({
                ...
                columns: [[
                      ...
                      { field: 'st_isend', title: '是末位吗', hidden: true },
                        ...
                        { field: 'fl_name', title: '所属流水线', width: 100, align: "center" },
                      { field: 'st_order', title: '排序序号', hidden: true },
                      { field: 'st_typename', title: '类型', width: 100, align: "center" },
                        { field: 'st_no', title: '工位号', width: 100, align: "center" },
                        { field: 'st_isfirstname', title: '首位', width: 100, align: "center" },
                        { field: 'st_isendname', title: '末位', width: 100, align: "center" },
                        { field: 'st_clock_Start', title: '计时开始(秒)', width: 70, align: "center" },
        ...
        function saveAllpart() {
            ...
            var st_clock_Start = $('#st_clock_Start').val();
            var st_clock = $('#st_clock').val();

            if (isNaN(st_clock_Start)) {
                alert("计时开始必须为整数，请重新输入");
                return;
            }
            if (isNaN(st_clock)) {
                alert("计时节拍必须为整数，请重新输入");
                return;
            }
        ...
        function initEidtWidget() {
            ...
            $('#st_clock_Start').val(row.st_clock_Start);
            $('#st_clock').val(row.st_clock);
