...
namespace Model
{
    public class mg_OperatorModel
    {
        ...
        private string _list_st_id;
        private string _list_st_no;
        ...
        /// 修改人：冉守旭
        /// </summary>
        public string list_st_no
        {
            set { _list_st_no = value; }
            get { return _list_st_no; }
        }
        /// <summary>
        /// 修改时间：2017年5月9日
        /// 修改人：冉守旭
        /// </summary>
        public string list_st_id
        {
            set { _list_st_id = value; }
            get { return _list_st_id; }
        }
        #endregion Model
    }
}
